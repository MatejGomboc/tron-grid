...
[[noreturn]] void check_equal_failed(std::string_view lhs_expr, std::string_view rhs_expr,
                                     std::string_view lhs_val, std::string_view rhs_val,
...
#define TEST_CHECK_EQUAL(a, b)                                                    \
    do {                                                                           \
        ...
        {                                                                          \
            ...
            ::test_fixture::check_equal_failed(#a, #b, to_str_(lhs_),             \
                                               to_str_(rhs_), __FILE__, __LINE__);\
        }                                                                          \
    } while (false)
...
#define TEST_CHECK_THROWS(expr)                                                   \
    do {                                                                           \
        ...
        if (!threw_)                                                               \
            ::test_fixture::check_failed(                                          \
                #expr " did not throw", __FILE__, __LINE__);                       \
    } while (false)
